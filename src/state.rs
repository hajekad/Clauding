...
pub const WORLD_SIZE: f32 = 30000.0;
pub const WORLD_HALF: f32 = WORLD_SIZE * 0.5;
pub const NUM_BUILDINGS: usize = 2000;
pub const NUM_TREES: usize = 15000;
pub const NUM_ROCKS: usize = 8000;
pub const NUM_STREET_LIGHTS: usize = 3000;
...
pub const LANE_OFFSET: f32 = CAR_ROAD_WIDTH * 0.25;
...
pub const NUM_NPCS: usize = 400;
pub const NUM_ITEMS: usize = 800;
pub const NPC_SPEED: f32 = 2.22; // 8 km/h Walk gait
pub const WORK_DURATION: f32 = 720.0;
pub const TERRAIN_GRID: usize = 1500;
pub const TERRAIN_CELL: f32 = WORLD_SIZE / TERRAIN_GRID as f32; // 20m per cell
...
pub const NUM_TRASH_BINS: usize = 300;
...
pub const DOCK_Z_START: f32 = 10500.0;
pub const WATER_Y: f32 = -1.0;
pub const RIVER_WIDTH: f32 = 40.0;
pub const RIVER_DEPTH: f32 = 5.0;
pub const RIVER_CURRENT: f32 = 2.0;
pub const DROWN_DAMAGE: f32 = 8.0;
pub const PARKING_LOT_COUNT: usize = 20;
